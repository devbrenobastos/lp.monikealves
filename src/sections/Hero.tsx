...
export const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Editorial Portrait - Top on mobile, right on desktop */}
        <div className="order-1 md:order-2 w-full md:col-span-5 relative self-stretch md:h-full min-h-[300px] md:min-h-[500px] flex items-center md:justify-end overflow-hidden animate-photo-reveal">
          {/* Portrait with aspect 4:5 on mobile and aspect-auto/full-height on desktop */}
        ...
        {/* Headline and CTA - Bottom on mobile, left on desktop */}
        <div className="order-2 md:order-1 w-full md:col-span-7 flex flex-col justify-center h-full">
          <div>
            ...
            <p className="font-sans text-[16px] text-ink-2 max-w-[46ch] mb-[32px] leading-relaxed opacity-0 animate-fade-up [animation-delay:160ms]">
          ...
          <div className="flex flex-col items-start w-full opacity-0 animate-fade-up [animation-delay:240ms]">
            ...
            <span className="font-sans text-[13px] text-ink-3 mt-[12px] block px-1">
              <T>Vagas limitadas — atendo poucas clínicas por vez.</T>
            </span>
          </div>

          {/* Social Proof */}
          <div className="mt-[24px] flex items-center gap-3 opacity-0 animate-fade-up [animation-delay:320ms]">
