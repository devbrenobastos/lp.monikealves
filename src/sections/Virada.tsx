  ...
  return (
    <section className="py-[clamp(80px,9vw,130px)] bg-panel border-b border-cream">
      ...
      >
        ...
        <div className="reveal-item max-w-[62ch] mx-auto text-left md:text-center mb-32">
        ...
        <div className="reveal-item max-w-[760px] mx-auto flex flex-col items-center text-center relative mt-8">
          <span className="absolute -top-10 left-1/2 -translate-x-1/2 font-serif text-[80px] text-olive opacity-25 leading-none select-none">“</span>
          
          <blockquote className="font-serif text-[28px] text-ink italic leading-[1.35] tracking-[0.01em] whitespace-pre-line text-center">
