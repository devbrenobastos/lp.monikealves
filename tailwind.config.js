...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-xl': ['clamp(1.75rem, 1.25rem + 2.5vw, 3.5rem)', { lineHeight: '1.2', letterSpacing: '-0.02em' }], // min 28px, max 56px
        'display-l': ['clamp(1.625rem, 1.2rem + 2vw, 2.75rem)', { lineHeight: '1.2', letterSpacing: '-0.02em' }], // min 26px, max 44px
        ...
        'mono-data': ['clamp(1.25rem, 1rem + 1vw, 1.875rem)', { lineHeight: '1.2', letterSpacing: '-0.02em' }], // max 30px
      },
      spacing: {
        '4': '4px',
        '8': '8px',
